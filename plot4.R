## Script to generate Plot 4 of Programming Assignment 1
...
plot(indat_relevant$PlotTime,indat_relevant$Voltage,
...
plot(indat_relevant$PlotTime,indat_relevant$Global_reactive_power,
